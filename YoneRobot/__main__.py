...
PM_START_TEXT = """
ʜᴇʟʟᴏ [🤗](https://telegra.ph/file/638ae38998d89f664cc0f.jpg), IM KAGUYA SAMA WITH A LOT OF TOOLS
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ADD KAGYA TO YOUR GROUP ➕️", url="t.me/KaguyaXRobot?startgroup=true"),
    ],
    [
